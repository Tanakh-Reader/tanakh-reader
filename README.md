...
* Set up a free-tier [Firebase account](https://firebase.google.com/)
...
1. Clone the repo
   ```sh
   git clone https://github.com/Tanakh-Reader/tanakh-reader.git
   ```
2. Run the Flutter app from VS-code or Andrio Studio
   ```sh
   cd flutter-app
   flutter run
   ```
...
- [x] Build a UI prototype
- [x] Add a Flutter Hive backend
...
Project Link: [https://github.com/Tanakh-Reader/tanakh-reader](https://github.com/Tanakh-Reader/tanakh-reader)
...
* [Flutter Book Course](https://www.kodeco.com/books/flutter-apprentice/v2.0/)
* [Flutter Video Course](https://www.udemy.com/course/learn-flutter-dart-to-build-ios-android-apps/)
* [Flutter Hive DB Docs](https://docs.hivedb.dev/)
